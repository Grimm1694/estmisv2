...
//   const facultyId = "1234";
  ...
  <div>
    ...
    <table className="table-auto w-full text-left mt-2">
      <tbody>
        <tr>
          <td className="font-medium text-gray-700">Prefix:</td>
          <td>{watch("personalSchema.prefix")}</td>
        </tr>
        <tr>
          <td className="font-medium text-gray-700">Full Name:</td>
          <td>{`${watch("personalSchema.firstName")} ${watch("personalSchema.lastName")}`}</td>
        </tr>
        <tr>
          <td className="font-medium text-gray-700">Email ID:</td>
          <td>{watch("personalSchema.emailId")}</td>
        </tr>
        <tr>
          <td className="font-medium text-gray-700">Contact Number:</td>
          <td>{watch("personalSchema.contactNo")}</td>
        </tr>
        
        <tr>
          <td className="font-medium text-gray-700">Date of Birth:</td>
          <td>
            {watch("personalSchema.dob") 
              ? new Date(watch("personalSchema.dob")).toLocaleDateString() 
              : "N/A"}
          </td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td>{watch("personalSchema.department")}</td>
        </tr>
        <tr>
          <td className="font-medium text-gray-700">Designation:</td>
          <td>{watch("personalSchema.designation")}</td>
        </tr>
        <tr>
          <td className="font-medium text-gray-700">Aided:</td>
          <td>{watch("personalSchema.aided")}</td>
        </tr>
        <tr>
          <td className="font-medium text-gray-700">Nationality:</td>
          <td>{watch("personalSchema.nationality")}</td>
        </tr>
        <tr>
          <td className="font-medium text-gray-700">Religion:</td>
  ...
  <div>
    ...
    <table className="table-auto w-full text-left mt-2">
      <tbody>
        <tr>
          <td className="font-medium text-gray-700">Permanent Address:</td>
          <td>{`${watch("personalSchema.firstAddressLine1")}, ${watch("personalSchema.firstAddressLine2")}, ${watch("personalSchema.firstAddressLine3")}`}</td>
        </tr>
        <tr>
          <td className="font-medium text-gray-700">Correspondence Address:</td>
          <td>{`${watch("personalSchema.correspondenceAddressLine1")}, ${watch("personalSchema.correspondenceAddressLine2")}, ${watch("personalSchema.correspondenceAddressLine3")}`}</td>
        </tr>
      </tbody>
    </table>
  </div>
  ...
  <div>
    ...
    <table className="table-auto w-full text-left mt-2">
      <tbody>
        <tr>
          <td className="font-medium text-gray-700">Bank Name:</td>
          <td>{watch("financialSchema.bankName")}</td>
        </tr>
        <tr>
          <td className="font-medium text-gray-700">Account Number:</td>
          <td>{watch("financialSchema.accountNo")}</td>
        </tr>
        <tr>
          <td className="font-medium text-gray-700">IFSC Code:</td>
  ...
  {/* Dependents */}
  <div>
    <h3 className="text-xl font-semibold text-gray-800">Dependents</h3>
    <table className="table-auto w-full text-left mt-2">
      <tbody>
        <tr>
          <td className="font-medium text-gray-700">Mother's Name:</td>
          <td>{watch("dependentsSchema.motherName")}</td>
        </tr>
        <tr>
          <td className="font-medium text-gray-700">Father's Name:</td>
          <td>{watch("dependentsSchema.fatherName")}</td>
        </tr>
        <tr>
          <td className="font-medium text-gray-700">Spouse's Name:</td>
          <td>{watch("dependentsSchema.spouseName")}</td>
        </tr>
        <tr>
          <td className="font-medium text-gray-700">Number of Children:</td>
    ...
    <table className="table-auto w-full text-left mt-2">
      <thead>
        <tr>
          ...
          <th className="font-medium text-gray-700">Institution</th>
          <th className="font-medium text-gray-700">Year of Passing</th>
          <th className="font-medium text-gray-700">Class</th>
        </tr>
      </thead>
      <tbody>
